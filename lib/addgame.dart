  ...
  void loadKf() async{
    ...
    if(ket!=null)
    {
      setState(() {
        ...
        if(ket.kfpts!=null&&ket.kfpts.isNotEmpty)
        {
            ...
            child: Column(children: [
              Row(children: [
                ...
                Container(
                  ...
                  child: const Text("添加游戏",style: TextStyle(color: Color(0xFF333333),fontWeight: FontWeight.bold, fontSize: 20)),
                ),
              ...
              Container(
                  ...
                  child: TextButton(onPressed: () async{
                    ...
                    String url="/Personal/TbGameAdd";
                    RequestClient requestClient = RequestClient();
                    InsertEntity? iet= await requestClient.post<InsertEntity>(url,data: formData,onError: (e){
                    ...
                    if(iet!=null)
                    {
                      bus.emit("setGames", "1");
                      if (context.mounted) {
                        Navigator.of(context).pop(TbGame(iet.insertid,selectedGameValue,selectedKfptItems.join(','),0));
                      }
                    }
                  },
                      style: ButtonStyle(
